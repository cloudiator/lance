...
public class ComponentInstanceLifecycleTest {
  ...
  private void bootstrap(boolean createRegistry) throws RegistrationException {
    ...
    if (createRegistry) core.fillRegistry();
  ...
  public void initWithMinimalStore() throws RegistrationException {
    ...
    assertEquals(
        Arrays.asList(new HandlerType[] {LifecycleHandlerType.NEW}), interceptor.invokedHandlers());
  ...
  public void startWithMinimalStore() throws RegistrationException, LifecycleException {
    ...
    assertEquals(
        Arrays.asList(
            new HandlerType[] {
              LifecycleHandlerType.NEW, LifecycleHandlerType.INIT, LifecycleHandlerType.PRE_INSTALL,
              LifecycleHandlerType.INSTALL, LifecycleHandlerType.POST_INSTALL,
    ...
    assertTrue(
        ...
        creator.checkHandlerHasBeenInvoked(LifecycleHandlerType.START, 1));
  ...
  private void checkBasicRegistryValue(int compInstances, LifecycleHandlerType expectedType)
