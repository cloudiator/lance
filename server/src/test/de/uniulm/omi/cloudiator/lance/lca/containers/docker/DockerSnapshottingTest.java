...
public class DockerSnapshottingTest {
  ...
  public void testCreation() throws ContainerException {
    ...
    AbstractDockerContainerLogic logic =
        builder
            .cInstId(core.componentInstanceId)
            .dockerConnector(client)
            .deplComp(core.comp)
            .deplContext(core.ctx)
            .osParam(OperatingSystem.UBUNTU_14_04)
            .nwHandler(core.networkHandler)
            .dockerShellFac(shellFactory)
            .dockerConfig(dockerConfig)
            .hostContext(new FakeHostContext())
            .build();
    logic.doCreate();
  ...
  public void testSnapshot() throws ContainerException {
    ...
    // split for better readability
    AbstractDockerContainerLogic logic2 =
        builder2
            .cInstId(core.componentInstanceId)
            .dockerConnector(client)
            .deplComp(core.comp)
