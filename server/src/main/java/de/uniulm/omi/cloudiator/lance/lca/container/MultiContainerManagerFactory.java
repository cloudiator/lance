...
public final class MultiContainerManagerFactory {
  ...
  public static ContainerManager createContainerManager(
      HostContext contex, OperatingSystem operatingSystem, ContainerType containerType) {
    ...
    switch (operatingSystem.getFamily()) {
      ...
      default:
        throw new IllegalStateException(
            "No matching Operating System found: " + operatingSystem.toString());
    }
  }
  ...
  private static ContainerManager createLinuxContainerManager(
      HostContext hostContext, ContainerType containerType) {

    switch (containerType) {
      case DOCKER:
        return ContainerManagerFactory.createContainerManager(hostContext, ContainerType.DOCKER);
      ...
      default:
        throw new IllegalStateException(
            "No matching Container "
                ...
                + " for Operating System Linux found!");
    }
  }
}
