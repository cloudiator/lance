...
public class PlainContainerManager implements ContainerManager {
  ...
  public ContainerController createNewLifecycleContainer(
    ...
    AbstractComponentDependencies cDeps =
        new AbstractComponentDependencies(ctx, component, hostContext);
    ...
    PlainContainerLogic plainContainerLogic =
        builder
            .cInstId(cDeps.componentInstanceId)
            .deplComp(component)
            .deplContext(ctx)
            .operatingSys(os)
            .nwHandler(cDeps.networkHandler)
    ...
    ContainerController containerController =
        new ErrorAwareContainer<>(
            cDeps.componentInstanceId,
            plainContainerLogic,
            cDeps.networkHandler,
            lifecycleController,
            cDeps.accessor,
            shouldBeRemoved);
