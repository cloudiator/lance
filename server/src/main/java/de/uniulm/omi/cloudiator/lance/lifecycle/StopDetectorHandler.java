...
final class StopDetectorHandler implements Runnable {
  ...
  private StopDetectorHandler(
      LifecycleActionInterceptor interceptorP,
      StopDetector detector2,
      ExecutionContext ecP,
      StopDetectorCallback callbackParam) {
  ...
  static StopDetectorHandler create(
      LifecycleActionInterceptor interceptor,
