...
public class LifecycleControllerTransitions {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(LifecycleControllerTransitions.class);
  final LifecycleStore store;
  final ExecutionContext ec;

  private LifecycleControllerTransitions(LifecycleStore storeParam, ExecutionContext ecParam) {
    if (storeParam == null) throw new NullPointerException("store must be set.");
    store = storeParam;
    ec = ecParam;
  }
  ...
  static StateMachine<LifecycleHandlerType> buildStateMachine(
      LifecycleStore storeParam, ExecutionContext ecParam) {
    LifecycleControllerTransitions transitions =
        new LifecycleControllerTransitions(storeParam, ecParam);
    return transitions
        .addInitTransition(
  ...
  private StateMachineBuilder<LifecycleHandlerType> addInitTransition(
      StateMachineBuilder<LifecycleHandlerType> b) {
    return b.addSynchronousTransition(
        LifecycleHandlerType.NEW,
  ...
  private StateMachineBuilder<LifecycleHandlerType> addInstallTransitions(
      StateMachineBuilder<LifecycleHandlerType> b) {
    return b.addSynchronousTransition(
            LifecycleHandlerType.INIT,
            ...
            new TransitionAction() {
              ...
              public void transit(Object[] params) {
                PreInstallHandler h =
                    store.getHandler(LifecycleHandlerType.PRE_INSTALL, PreInstallHandler.class);
                try {
                  h.execute(ec);
                } catch (LifecycleException lce) {
                  throw new RuntimeException(lce);
        ...
        .addSynchronousTransition(
            ...
            new TransitionAction() {
              ...
              public void transit(Object[] params) {
                InstallHandler h =
                    store.getHandler(LifecycleHandlerType.INSTALL, InstallHandler.class);
                try {
                  h.execute(ec);
                } catch (LifecycleException lce) {
                  throw new RuntimeException(lce);
            ...
            new TransitionAction() {
              ...
              public void transit(Object[] params) {
                PostInstallHandler h =
                    store.getHandler(LifecycleHandlerType.POST_INSTALL, PostInstallHandler.class);
                try {
                  h.execute(ec);
                } catch (LifecycleException lce) {
                  throw new RuntimeException(lce);
  ...
  private StateMachineBuilder<LifecycleHandlerType> addStartTransitions(
      StateMachineBuilder<LifecycleHandlerType> b) {
    return b.addSynchronousTransition(
            LifecycleHandlerType.POST_INSTALL,
            ...
            new TransitionAction() {
              ...
              public void transit(Object[] params) {
                PreStartHandler h =
                    store.getHandler(LifecycleHandlerType.PRE_START, PreStartHandler.class);
                try {
                  h.execute(ec);
                } catch (LifecycleException lce) {
                  throw new RuntimeException(lce);
        ...
        .addSynchronousTransition(
            ...
            new TransitionAction() {
              ...
              public void transit(Object[] params) {
                PostStartHandler h =
                    store.getHandler(LifecycleHandlerType.POST_START, PostStartHandler.class);
                try {
                  h.execute(ec);
                } catch (LifecycleException lce) {
                  throw new RuntimeException(lce);
  ...
  private StateMachineBuilder<LifecycleHandlerType> addStopTransitions(
      StateMachineBuilder<LifecycleHandlerType> b) {
    return b.addSynchronousTransition(
            LifecycleHandlerType.POST_START,
            ...
            new TransitionAction() {
              ...
              public void transit(Object[] params) {
                PreStopHandler h =
                    store.getHandler(LifecycleHandlerType.PRE_STOP, PreStopHandler.class);
                try {
                  h.execute(ec);
                } catch (LifecycleException lce) {
                  throw new RuntimeException(lce);
        ...
        .addSynchronousTransition(
            ...
            new TransitionAction() {
              ...
              public void transit(Object[] params) {
                PostStopHandler h =
                    store.getHandler(LifecycleHandlerType.POST_STOP, PostStopHandler.class);
                try {
                  h.execute(ec);
                } catch (LifecycleException lce) {
                  throw new RuntimeException(lce);
