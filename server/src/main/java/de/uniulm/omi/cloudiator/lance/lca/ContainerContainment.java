...
final class ContainerContainment implements BasicContainer {
  ...
  // Returns reference to DockerContainerManager object if ContainerType==DOCKER/DOCKER-REMOTE else
  // to PlainContainerManager object
  public ContainerManager getLifecycleContainerManager(
      HostContext context, OperatingSystem operatingSystem, ContainerType containerType)
      throws LcaException {
    ...
    throw new LcaException(
        "Operating System and container do not match: " + operatingSystem.toString());
  }
  ...
  // Returns reference to DockerContainerManager object
  public DockerContainerManager getRemoteDockerContainerManager(
      HostContext context, RemoteDockerComponent.DockerRegistry dReg) {
    // todo: refactor
  ...
  private ContainerManager getContainerManager(
      HostContext contex, RemoteDockerComponent.DockerRegistry dReg) {
    synchronized (managers) {
