...
public final class StandardContainer<T extends ContainerLogic> implements ContainerController {
  ...
  public StandardContainer(
    ...
    stateMachine =
        addDestroyTransition(
                addInitTransition(
                    addBootstrapTransition(
                        addCreateTransition(
                            new StateMachineBuilder<>(ContainerStatus.NEW)
  ...
  private StateMachineBuilder<ContainerStatus> addCreateTransition(
      StateMachineBuilder<ContainerStatus> b) {
    return b.addAsynchronousTransition(
        ContainerStatus.NEW,
  ...
  private StateMachineBuilder<ContainerStatus> addBootstrapTransition(
      StateMachineBuilder<ContainerStatus> b) {
    return b.addAsynchronousTransition(
        ContainerStatus.CREATED,
        ContainerStatus.BOOTSTRAPPING,
        ContainerStatus.BOOTSTRAPPED,
        new TransitionAction() {
          @Override
          public void transit(Object[] params) {
            try {
  ...
  private StateMachineBuilder<ContainerStatus> addInitTransition(
      StateMachineBuilder<ContainerStatus> b) {
    return b.addAsynchronousTransition(
        ContainerStatus.BOOTSTRAPPED,
        ContainerStatus.INITIALISING,
        READY,
        new TransitionAction() {
          @Override
          public void transit(Object[] params) {
  ...
  private StateMachineBuilder<ContainerStatus> addDestroyTransition(
      StateMachineBuilder<ContainerStatus> b) {
    return b.addAsynchronousTransition(
        READY,
        ContainerStatus.SHUTTING_DOWN,
          ...
          public void transit(Object[] params) {
            ...
            try {
              ...
              try {
                ...
                getLogger()
                    .error(
                        "could not shut down component; trying to force shut down of container",
                        ex);
                forceShutdown = true;
              }
