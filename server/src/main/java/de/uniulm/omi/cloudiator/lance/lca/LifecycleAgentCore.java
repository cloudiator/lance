...
public class LifecycleAgentCore {

    private static final Logger LOGGER = LoggerFactory.getLogger(LifecycleAgentCore.class);
    ...
    LifecycleAgentCore(HostContext contex) {
    ...
    public List<ComponentInstanceId> listContainers() {
