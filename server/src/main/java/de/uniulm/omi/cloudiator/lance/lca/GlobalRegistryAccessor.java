...
import static de.uniulm.omi.cloudiator.lance.lca.LcaRegistryConstants.COMPONENT_INSTANCE_STATUS;
...
public final class GlobalRegistryAccessor {
  ...
  public GlobalRegistryAccessor(
      DeploymentContext ctxParam, AbstractComponent compParam, ComponentInstanceId localIdParam) {
  ...
  public static boolean dumpMapHasContainerStatus(Map<String, String> map, ContainerStatus type) {
    if (type == null) throw new NullPointerException("type has to be set");
  ...
  public final void init(ComponentInstanceId myId) throws RegistrationException {
    ...
    reg.addComponentProperty(
        appInstId, compId, myId, COMPONENT_INSTANCE_STATUS, LifecycleHandlerType.NEW.toString());
  }

  public final void updateInstanceState(ComponentInstanceId myId, LifecycleHandlerType type)
      throws RegistrationException {
    reg.addComponentProperty(appInstId, compId, myId, COMPONENT_INSTANCE_STATUS, type.toString());
  }

  public final void updateContainerState(ComponentInstanceId myId, ContainerStatus type)
      throws RegistrationException {
  ...
  */
  ...
  public Map<ComponentInstanceId, Map<String, String>> retrieveComponentDump(
      PortReference sinkReference) throws RegistrationException {
  ...
  public String getComponentInstanceProperty(ComponentInstanceId myId, String key)
      throws RegistrationException {
