...
public enum OperatingSystemType {
     ...
     * @return the OperatingSystemType instance, if <i>name</i> matches the toString() 
     * representation of this OperatingSystemType ignoring case. Otherwise <i>null</i> 
     * is returned.
     */
    ...
    /**
     * @return the default version or null if DefaultVersion is not available for
     * this OSType
     * 
     * needs to be overridden by each type.
     */
    public OperatingSystemVersion getDefaultVersion() {
        return null;
    }
