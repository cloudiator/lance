...
//  *ComponentId
//  *DeployableComponentBuilderId
//  *PortType
//  *PortUpdateHandler
//  *LifeCycleStore
//  *LifeCycleStoreBuilder
//  *BashBasedHandlerBuilder
//  *OperatingSystem
//  *LifeCycleHandler
...
//Prerequs: Auf OmiStack muss vm deployed sein mit fixem os und floating-ip und sw-Komponenten aus ansible-installern. Wichtig, lance lca-port: 4001 für etcd muss
// offen sein. (Alternativ port 33034 für rmi registry)
...
//wichtig: Java und Lance(Server) müssen auf VM installiert sein und entsprechende ports
//(inkl. RMI ports: 1099, 33033) müssen nach aussen geöffnet sein
...
public class ClientRMTest {
    ...
    public static void configureAppContext() {
        ...
        //etcd auf localhost laufen lassen, reqs: $ nc -l 4001; etcd4j netty client installieren und(?) etcd auf lokaler Maschine
