...
public interface DockerShellTestAgent extends Remote{
  ...
  ApplicationInstanceId setupContainer(AppArchitecture arch, String publicIp, LcaRegistry reg)  throws ContainerException, RemoteException;
  void openShellAndCreateContainer(String imageName, Map<Integer,Integer> portMap)  throws ContainerException, RemoteException;
