...
public final class RemoteRegistryImpl implements RmiLcaRegistry {
  ...
  @Override
  public synchronized Map<ComponentInstanceId, Map<String, String>> dumpComponent(
   ...
   */
  public synchronized boolean addApplicationInstance(
      ApplicationInstanceId instId, ApplicationId appId, String name) throws RemoteException {
  ...
  @Override
  public synchronized void addComponent(ApplicationInstanceId instId, ComponentId cid, String name)
  ...
  @Override
  public synchronized void addComponentInstance(
  ...
  @Override
  public synchronized void addComponentProperty(
