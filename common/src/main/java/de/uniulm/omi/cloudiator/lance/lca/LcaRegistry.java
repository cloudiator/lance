...
/**
 * interface to the global registry where properties are being stored; encapsulates the actual
 * implementation
 */
public interface LcaRegistry extends Serializable {
   ...
   * @return @return true if this application instance has been added successfully. false if it was
   *     already contained in the registry.
