...
public interface ReplaceFileContentCommand extends Command {
  ...
  public static class ReplaceFileContentCommandFactory {
    ...
    public static ReplaceFileContentCommand create(
        LifecycleHandlerType inPhase,
        CommandResultReference ref,
        String pattern,
        String replacement) {
      ...
      throw new IllegalStateException(
          "ReplaceFileContentCommand cannot be executed at Lifecylce Phase " + inPhase);
    }
  }
}
...
class ReplaceFileContentImpl implements ReplaceFileContentCommand {
  ...
  ReplaceFileContentImpl(
      ...
      CommandResultReference refParam,
      String patternParam,
