...
public interface SetFilePropertiesCommand extends Command {
  ...
  public static class SetFilePropertiesCommandFactory {
    ...
    public static SetFilePropertiesCommand setAccessRights(
        LifecycleHandlerType inPhase, int access, int users, CommandResultReference reference) {
...
final class SetFilePropertiesCommandImpl implements SetFilePropertiesCommand {
  ...
  private static final String getAccessString(int access) {
