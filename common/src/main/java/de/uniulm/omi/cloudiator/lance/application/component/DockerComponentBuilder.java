...
public class DockerComponentBuilder {
    ...
    private DockerComponentBuilder(String nameParam, ComponentId idParam) {
        name = nameParam;
        componentId = idParam;
    }
    ...
    public static DockerComponentBuilder createBuilder(String name, ComponentId componentId) {
        return new DockerComponentBuilder(name, componentId);
    }
    ...
    public DockerComponent build() {
        return new DockerComponent(name, componentId, store, inports, outports, properties, propertyValues);
    }
